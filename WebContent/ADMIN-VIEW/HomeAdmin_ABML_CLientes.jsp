...
<div class="d-flex vh-100">
    ...
    <div class="main-content w-100">
        <header class="d-flex justify-content-center w-100 mt-5 h2">
            <label for="txtNombre" class="form-label">Administrador:</label>
	...
	<h1>SOLICITUDES DE ACTIVACION</h1>	
 <table class="table">
            <thead>
            ...
            <tbody>
                <tr>
                    ...
                    <td>INACTIVO</td>
                  <td><button class="btn btn-success btn-activate" data-bs-toggle="modal" data-bs-target="#activateModal">ACTIVAR</button></td>
                </tr>
                <tr>
                    <td>32911988</td>
                    <td>ROCUZZO</td>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>DEAN FUNES 375</td>
                    <td>ACTIVO</td>
                  <td><button class="btn btn-primary btn-edit" data-bs-toggle="modal" data-bs-target="#editModal">Editar</button>
                        <button class="btn btn-danger btn-edit" data-bs-toggle="modal" data-bs-target="#deleteModal">Eliminar</button></td>
                </tr>
                <tr>
                    <td>32911988</td>
                    <td>ROCUZZO</td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="activateForm">
         <div class="mb-3">
            <label for="adni" class="form-label">DNI</label>
            <input type="text" class="form-control" id="adni" name="adni" readonly>
          </div>
          <div class="mb-3">
            <label for="aapellido" class="form-label">Apellido</label>
            <input type="text" class="form-control" id="aapellido" name="aapellido">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="acuil" class="form-label">CUIL</label>
            <input type="text" class="form-control" id="acuil" name="acuil">
          </div>
          <div class="mb-3">
            <label for="anacionalidad" class="form-label">Nacionalidad</label>
            <input type="text" class="form-control" id="anacionalidad" name="anacionalidad">
          </div>
          <div class="mb-3">
            <label for="afechaNacimiento" class="form-label">Fecha de Nacimiento</label>
            <input type="text" class="form-control" id="afechaNacimiento" name="afechaNacimiento">
          </div>
          <div class="mb-3">
            <label for="adireccion" class="form-label">Dirección</label>
            <input type="text" class="form-control" id="adireccion" name="adireccion">
          </div>
           <div class="mb-3">
            <label for="alocalidad" class="form-label">Localidad</label>
            <input type="text" class="form-control" id="alocalidad" name="alocalidad">
          </div>
            <div class="mb-3">
           <label for="aprovincia" class="form-label">Provincia</label>
            <input type="text" class="form-control" id="aprovincia" name="aprovincia">
         	</div>
          	<div class="mb-3">
                <label for="amail" class="form-label">E-mail</label>
                <input type="email" class="form-control" id="amail" name="amail" required>
             </div>
          <div class="col-md-6">
        <label for="atelefono" class="form-label">Teléfono</label>
        <input type="tel" class="form-control" id="atelefono" name="atelefono" required>
        </div>
        <div class="col-md-6">
        <label for="aUsuario" class="form-label">Usuario</label>
        <input type="text" class="form-control" id="aUsuario" name="aUsuario" required>
        </div>
  
        <div class="col-md-6">
        <label for="asexo" class="form-label">Sexo</label>
        <input type="text" class="form-control" id="asexo" name="asexo" required>
        </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="activateModalLabel">Eliminar Cliente</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...
        <form id="activateForm">
         <div class="mb-3">
            <label for="ddni" class="form-label">DNI</label>
            <input type="text" class="form-control" id="ddni" name="ddni" readonly>
          </div>
          <div class="mb-3">
            <label for="dapellido" class="form-label">Apellido</label>
          ...
          <div class="mb-3">
            <label for="dcuil" class="form-label">CUIL</label>
            <input type="text" class="form-control" id="dcuil" name="dcuil">
          </div>
          <div class="mb-3">
            <label for="dnacionalidad" class="form-label">Nacionalidad</label>
            <input type="text" class="form-control" id="dnacionalidad" name="dnacionalidad">
          </div>
          <div class="mb-3">
            <label for="dfechaNacimiento" class="form-label">Fecha de Nacimiento</label>
            <input type="text" class="form-control" id="dfechaNacimiento" name="dfechaNacimiento">
          </div>
          <div class="mb-3">
            <label for="ddireccion" class="form-label">Dirección</label>
            <input type="text" class="form-control" id="ddireccion" name="ddireccion">
          </div>
           <div class="mb-3">
            <label for="dlocalidad" class="form-label">Localidad</label>
            <input type="text" class="form-control" id="dlocalidad" name="dlocalidad">
          </div>
            <div class="mb-3">
           <label for="dprovincia" class="form-label">Provincia</label>
            <input type="text" class="form-control" id="dprovincia" name="dprovincia">
         	</div>
          	<div class="mb-3">
                <label for="dmail" class="form-label">E-mail</label>
                <input type="email" class="form-control" id="dmail" name="dmail" required>
             </div>
          <div class="col-md-6">
        <label for="dtelefono" class="form-label">Teléfono</label>
        <input type="tel" class="form-control" id="dtelefono" name="dtelefono" required>
        </div>
        <div class="col-md-6">
        <label for="dUsuario" class="form-label">Usuario</label>
        <input type="text" class="form-control" id="dUsuario" name="dUsuario" required>
        </div>
  
        <div class="col-md-6">
        <label for="dsexo" class="form-label">Sexo</label>
        <input type="text" class="form-control" id="dsexo" name="dsexo" required>
        </div>
